...
```{r libraries ultinivel, include=FALSE}
...
#### icc
moic_v<-glmer(var2~(1|cupo),family=binomial, data=icc2)
moic_0<-glmer(var2~ageg20+sexo+(1|cupo),family=binomial, data=icc2)
moic_1<-glmer(var2~ageg20+sexo+dm+ (1|cupo),family=binomial, data=icc2)
moic_2<-glmer(var2~ageg20+sexo+dm+ medea3_cat + (1|cupo),family=binomial, data=icc2)
